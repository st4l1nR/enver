...
const TextArea = React.forwardRef(({ error, ...props }: props, ref: any) => {
  return (
    <div>
      <div
        className={`border-2 border-gray-400 rounded-md focus-within:border-primary ${error && "border-red-500  focus-within:border-red-500"}`}
      >
        <textarea
